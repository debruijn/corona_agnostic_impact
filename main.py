from original_analysis import d_import_processing, d_eda, m_modeling_numpyro, m_postmodeling, o_output
...
def main():
    ...
    o_output.run(config)  # Create plots based on model results; was never finished
